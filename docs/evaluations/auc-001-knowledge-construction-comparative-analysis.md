...
- el proceso histórico de alta calidad representado por el informe experimental clasificado en `docs/evaluations/corpus/informe_calidad_leads_scoring_20260701.md`;
...
- `docs/evaluations/corpus/informe_calidad_leads_scoring_20260701.md`
...
- `docs/evaluations/corpus/informe_calidad_leads_20260510.md`
...
- `docs/evaluations/auc-001-end-to-end-traceability-test-report.md`
- `docs/evaluations/auc-001-regression-root-cause-analysis.md`
