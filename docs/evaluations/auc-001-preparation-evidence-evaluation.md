...
|---|---|---|
| [AUC-001 Discovery Contract](../handoffs/auc-001-discovery-contract.md) | Corrected Discovery Model | Revised after source-table review |
| [AUC-001 Source Table Review](../handoffs/auc-001-source-table-review.md) | Corrective decision record | Resolved for T-019/T-020; T-021 implemented |
| [AUC-001 Analytical Preparation](../handoffs/auc-001-analytical-preparation.md) | Corrected Analytical Model preparation | Approved |
| [AUC-001 Analytical Contract](../handoffs/auc-001-analytical-contract.md) | Analytical Model formalization | Documented |
| [AUC-001 Evidence Set](../handoffs/auc-001-evidence-set.md) | Observable evidence | Documented |
| [AUC-001 Evidence Contract](../handoffs/auc-001-evidence-contract.md) | Evidence handoff contract | Documented |
| [docs/tasks.md](../tasks.md) | Task status and dependencies | T-019 through T-023 Completed |
| [T-033 Context And Acquisition Evaluation](auc-001-context-acquisition-evaluation.md) | Upstream acquisition observations | Completed with observations |
