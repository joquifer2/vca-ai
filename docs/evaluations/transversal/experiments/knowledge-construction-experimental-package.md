...
| Validation Protocol | `docs/evaluations/transversal/experiments/knowledge-construction-profile-validation-protocol.md` | Canonical remediated protocol | `1.0.0-remediated` | This package | Yes |
...
- `docs/evaluations/transversal/experiments/knowledge-construction-profile-validation-protocol.md`

Files created by this remediation:

- `docs/evaluations/transversal/experiments/knowledge-construction-experimental-package.md`
- `docs/evaluations/transversal/diagnostics/knowledge-construction-remediation-report.md`
