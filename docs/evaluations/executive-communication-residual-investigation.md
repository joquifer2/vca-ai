...
|---|---|---|
| [SPEC-011 Executive Representation Discrimination Plan](spec-011-executive-representation-discrimination-plan.md) | Define hipótesis, variables controladas y criterios de falsación | Revisado |
| [SPEC-011 Executive Representation Discrimination Experimental Record](spec-011-executive-representation-discrimination-experimental-record.md) | Registra el protocolo ejecutado y los controles de equivalencia | Revisado |
