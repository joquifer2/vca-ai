...
| Package Manifest | docs/evaluations/knowledge-construction-experimental-package.md |
...
Usar exactamente el paquete definido en `docs/evaluations/knowledge-construction-experimental-package.md`.
