...
|---|---|---|
| [AUC-001 Regression Root Cause Analysis](auc-001-regression-root-cause-analysis.md) | Identifica la divergencia en la resolución de la invocación | Revisado |
| [AUC-001 Regression Containment Review](auc-001-regression-containment-review.md) | Contención documental de la ejecución inválida | Revisado |
| [AUC-001 Data Contract](../handoffs/auc-001-data-contract.md) | Límite autorizado de datos y proveedor | Revisado |
| [AUC-001 BigQuery MCP Integration Validation](auc-001-bigquery-mcp-integration-validation.md) | Referencia del canal MCP validado | Revisado |
| [AUC-001 Executive Output Artifact](../handoffs/auc-001-executive-report.md) | Baseline canónico de salida | Revisado |
| [AUC-001 Presentation Output Documentary Evaluation](auc-001-presentation-output-evaluation.md) | Baseline documental de representación | Revisado |
| [AUC-001 End-To-End Traceability Test Report](auc-001-end-to-end-traceability-test-report.md) | Baseline de trazabilidad | Revisado |
...
| [AUC-001 Context References](../context_refs.md) | Contexto oficial del repositorio | Revisado |
