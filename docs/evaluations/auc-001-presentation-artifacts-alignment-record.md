...
| Source | Role |
|---|---|
| `docs/evaluations/auc-001-documentary-alignment-decision.md` | T-043 authorization and artifact classification |
| `docs/evaluations/auc-001-base-contracts-alignment-record.md` | T-044 aligned base contract language |
| `docs/evaluations/auc-001-presentation-alignment-assessment.md` | T-041 AUC artifact gap evidence |
...
| `docs/evaluations/auc-001-presentation-projection-architectural-decision.md` | Sibling-projection and non-derivation source |
