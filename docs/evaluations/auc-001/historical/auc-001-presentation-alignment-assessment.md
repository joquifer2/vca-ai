...
| `docs/evaluations/auc-001/historical/auc-001-base-contracts-alignment-assessment.md` | T-040 input and base contract findings |
| `docs/evaluations/auc-001/validations/auc-001-presentation-output-evaluation.md` | Prior presentation/output boundary evaluation |
