...
|---|---|---|
| [AUC-001 Data Contract](/docs/handoffs/auc-001-data-contract.md) | Delimita el proveedor, el alcance y las limitaciones documentadas | Documentado; MCP pendiente en el contrato |
| [AUC-001 BigQuery MCP Integration Validation](/docs/evaluations/auc-001/validations/auc-001-bigquery-mcp-integration-validation.md) | Valida acceso directo MCP para un scope técnico concreto | PASS WITH OBSERVATIONS |
| [AUC-001 Presentation Output Documentary Evaluation](/docs/evaluations/auc-001/validations/auc-001-presentation-output-evaluation.md) | Valida la salida ejecutiva aprobada | Pass |
| [AUC-001 End-To-End Traceability Test Report](/docs/evaluations/auc-001/validations/auc-001-end-to-end-traceability-test-report.md) | Verifica trazabilidad end-to-end | PASS |
| [AUC-001 Development Entry Readiness Evidence](/docs/evaluations/auc-001/validations/auc-001-development-entry-readiness-evidence.md) | Consolida el cierre documental de AUC-001 | PASS WITH OBSERVATIONS |
| [AUC-001 Executive Output Artifact](/docs/handoffs/auc-001-executive-report.md) | Baseline ejecutivo aprobado | Documented |
| [Current report under regression](/outputs/auc-001/2026-06-30/analytical-report.md) | Última ejecución observada | Revisado |
...
El informe [meta-ads-lead-quality-report-to-2026-06-30-from-zero.md](/outputs/auc-001/2026-06-30/analytical-report.md) debe considerarse inválido como evidencia oficial de AUC-001.
...
La última validación documental y técnica explícita de acceso directo MCP es [AUC-001 BigQuery MCP Integration Validation](/docs/evaluations/auc-001/validations/auc-001-bigquery-mcp-integration-validation.md), con alcance técnico validado sobre `datamart-vca-494114.intermediate.int_faro_lead_scoring`.
...
La última versión conocida coherente con los artefactos canónicos aprobados es el [AUC-001 Executive Output Artifact](/docs/handoffs/auc-001-executive-report.md), validado documentalmente por T-036, T-037 y T-038.
...
1. Invalidar el informe [meta-ads-lead-quality-report-to-2026-06-30-from-zero.md](/outputs/auc-001/2026-06-30/analytical-report.md) como evidencia oficial de AUC-001.
