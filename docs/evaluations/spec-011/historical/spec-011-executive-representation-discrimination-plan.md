...
| [VCA-AUC-001-ARCH-003 Communication Context Representation Transformation](/docs/decisions/auc-001/auc-001-communication-context-representation-transformation-architectural-decision.md) | Establishes the reusable architectural responsibility around Communication Context-driven representation. |
| [AUC-001 Presentation Contract](/docs/handoffs/auc-001-presentation-contract.md) | Delimits the approved content and representation invariants for the selected output. |
...
- [VCA-AUC-001-ARCH-003 Communication Context Representation Transformation](/docs/decisions/auc-001/auc-001-communication-context-representation-transformation-architectural-decision.md)
