...
| [VCA-AUC-001-ARCH-003 Communication Context Representation Transformation](/docs/decisions/auc-001/auc-001-communication-context-representation-transformation-architectural-decision.md) | Límite arquitectónico que define la responsabilidad reusable de transformación. |
...
| [SPEC-011 Planning Phase Methodological Observation](/docs/evaluations/spec-011/investigations/spec-011-methodological-observation.md) | Evidencia de que la traducción de una specification a un backlog implementable se comporta como una fase metodológica distinta. |
| [docs/tasks.md](/docs/tasks.md) | Registro actual de tareas que contiene el puente de fase de planificación representado por T-048, T-049 y T-050. |
