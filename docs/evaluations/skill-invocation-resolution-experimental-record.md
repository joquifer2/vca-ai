...
| Related Plan | `docs/evaluations/skill-invocation-resolution-investigation-plan.md` |
...
|---|---|
| `docs/evaluations/skill-invocation-resolution-investigation-plan.md` | Invocation matrix and controls to record |
...
- Output references `docs/evaluations/skill-invocation-resolution-investigation-plan.md`.
...
```text
Repetido el análisis usando la invocación `I-06`: “Repite el análisis usando el workflow canónico oficial de AUC-001”, definida en [skill-invocation-resolution-investigation-plan.md](C:/Workspace/VCA/vca-ai/docs/evaluations/skill-invocation-resolution-investigation-plan.md:131).
...
Ese flujo está definido en [SKILL.md](C:/Workspace/VCA/vca-ai/.github/skills/meta-lead-quality-analysis/SKILL.md:96) y reforzado por el prompt oficial, que obliga a revisar artefactos canónicos, reconstruir el workflow y usar BigQuery MCP cuando el scope lo soporte en [lead_quality_analytical_report.md](C:/Workspace/VCA/vca-ai/.github/prompts/lead_quality_analytical_report.md:11).

**Lectura corregida**
La ejecución regresiva viola los controles canónicos `C-02` a `C-10`: contexto oficial, MCP, Data Contract, Evidence Set, Knowledge Set, Recommendation Set y representación sobre artefactos estabilizados. Esos controles están explicitados en [skill-invocation-resolution-investigation-plan.md](C:/Workspace/VCA/vca-ai/docs/evaluations/skill-invocation-resolution-investigation-plan.md:139).
...
```text
Usé la skill oficial [meta-lead-quality-analysis](C:/Workspace/VCA/vca-ai/.github/skills/meta-lead-quality-analysis/SKILL.md:1) como marco de lectura y la contrasté con el AUC, handoffs, evaluaciones y pruebas del repo.
...
- Context Definition validado: [auc-001-context-definition.md](C:/Workspace/VCA/vca-ai/docs/handoffs/auc-001-context-definition.md:56)
- Evidence Set observable: [auc-001-evidence-set.md](C:/Workspace/VCA/vca-ai/docs/handoffs/auc-001-evidence-set.md:1)
- Knowledge Set estabilizado: [auc-001-knowledge-set.md](C:/Workspace/VCA/vca-ai/docs/handoffs/auc-001-knowledge-set.md:1)
- Recommendation Set priorizado: [auc-001-recommendation-set.md](C:/Workspace/VCA/vca-ai/docs/handoffs/auc-001-recommendation-set.md:1)
- Executive Report como proyección seleccionada: [auc-001-executive-report.md](C:/Workspace/VCA/vca-ai/docs/handoffs/auc-001-executive-report.md:8)
...
- BigQuery MCP está validado para `intermediate.int_faro_lead_scoring`, pero no reejecuta todo T-018 vía MCP: [auc-001-bigquery-mcp-integration-validation.md](C:/Workspace/VCA/vca-ai/docs/evaluations/auc-001-bigquery-mcp-integration-validation.md:13)
- Quedan limitaciones de datos: sin impresiones/clicks/CTR, sin metadata creativa, y campaña/adset parcialmente condicionado.
- Hay una tensión menor de gobernanza: el frontmatter del AUC sigue en `status: Proposed` aunque el cierre documental dice `Pass with observations`: [meta_lead_quality_analysis.md](C:/Workspace/VCA/vca-ai/analytical_use_cases/meta_lead_quality_analysis.md:5)
