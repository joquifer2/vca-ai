...
|---|---|---|
| [AUC-001 Analysis Request](../handoffs/auc-001-analysis-request.md) | Request intake | Validated |
| [AUC-001 Execution Context](../handoffs/auc-001-execution-context.md) | Execution instance | Validated and frozen |
| [AUC-001 Context Resolution](../handoffs/auc-001-context-resolution.md) | Official context resolution | Validated |
| [AUC-001 Context Definition](../handoffs/auc-001-context-definition.md) | Phase 0 Context output | Validated |
| [AUC-001 Data Contract](../handoffs/auc-001-data-contract.md) | Case-specific Data Contract | Documented; provider exposure verified in T-018 |
| [AUC-001 Evidence Acquisition](../handoffs/auc-001-evidence-acquisition.md) | Initial acquisition record | Completed with limitations |
| [docs/context_refs.md](../context_refs.md) | Official context and provider reference index | Available; BigQuery MCP documentation PENDING |
| [docs/tasks.md](../tasks.md) | Task status and dependencies | T-015 through T-018 Completed |
