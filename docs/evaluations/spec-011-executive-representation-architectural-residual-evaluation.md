...
| Related Experimental Record | `docs/evaluations/spec-011-executive-representation-discrimination-experimental-record.md` |
...
|---|---|---|
| [SPEC-011 Executive Representation Discrimination Plan](spec-011-executive-representation-discrimination-plan.md) | Defines the hypothesis, controlled variables and falsification criteria | Reviewed |
| [SPEC-011 Executive Representation Discrimination Experimental Record](spec-011-executive-representation-discrimination-experimental-record.md) | Records the executed protocol and equivalence controls | Reviewed |
