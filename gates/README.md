...
The original namespace `outputs/auc-001/2026-06-30/` is immutable historical output from the closed cycle. `outputs/auc-001-pci-001/` is not authorized. Future post-closure iterations must use `outputs/auc-001/pci-00N/<execution-date>/`.
