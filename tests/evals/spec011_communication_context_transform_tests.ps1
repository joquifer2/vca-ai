...
Assert-True 'Experimental active dimension is traceability_visibility' ($output.representation_constraints.experimental_active_dimension -eq 'traceability_visibility' -and ($output.representation_constraints.deferred_dimensions -contains 'abstraction_level') -and ($output.representation_constraints.deferred_dimensions -contains 'information_density') -and ($output.representation_constraints.deferred_dimensions -contains 'vocabulary') -and ($output.representation_constraints.deferred_dimensions -contains 'narrative_organization')) 'SPEC-011 experimental scope; WP-002' 'Other representation dimensions remain deferred'
