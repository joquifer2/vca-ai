...
| Estado de validacion | Validated |
...
|---|---|
| Definicion del caso | [../meta_lead_quality_analysis.md](../meta_lead_quality_analysis.md) |
...
| Producto analitico final validado | [../../outputs/auc-001/2026-06-30/analytical-report.md](/outputs/auc-001/2026-06-30/analytical-report.md) |
...
- SPEC-009 permanece como Draft y validada provisionalmente dentro de `vca-ai`; no se promueve a Foundation en esta reestructuracion.
- El informe ejecutivo permanece temporalmente en `docs/handoffs/` como handoff documentado.
- La politica completa de almacenamiento de futuras ejecuciones queda fuera de alcance de esta migracion.